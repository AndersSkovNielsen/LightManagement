...
module.exports = {
  ...
  entry: ['./src/index.htm', './src/LoginSide.htm', './src/Hovedmenu.htm', './src/Indstillinger.htm', './src/scss/styles.scss', './src/js/index.ts', './src/js/Login.ts', './src/js/Bruger.ts', './src/js/Clock.ts'],
  module: {
